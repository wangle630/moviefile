...
var mogo_post = require('./handlers/mogo_post.js');
var mogo_user = require('./handlers/mogo_user.js');
var mysql_user = require('./handlers/mysql_user.js');
var api = require('./handlers/api.js');
var mf = require('./handlers/handler_mf.js');
var douban = require('./handlers/handler_douban.js');
var spider = require('./spiders/spider.js');
...
module.exports = function(app){
    ...
    //app.get('/spider',spider.getDbComments);
    app.post('/spider',spider.getDbComments);
    app.get('/rtmp',mf.rtmpPlay);



    app.post('/api/doubansave',douban.douban_save);
    app.post('/api/filesave',douban.file_save);
